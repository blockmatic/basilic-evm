...
See **[API Contracts](/docs/architecture/api-contracts)** for detailed philosophy and implementation strategy.
...
- [Code-First APIs](/docs/contracts) - Code-first development approach
