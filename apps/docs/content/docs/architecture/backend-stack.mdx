...
- [ADR 002: Backend Framework](/docs/adrs/002-backend-framework) - Runtime and framework decision
- [ADR 007: Backend ORM](/docs/adrs/007-backend-orm) - Database ORM selection
- [ADR 008: Database Platform](/docs/adrs/008-database) - Database platform strategy
