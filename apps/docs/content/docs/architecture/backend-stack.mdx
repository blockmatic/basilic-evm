...
See [Security Guide](/docs/guides/security#api-security) for detailed security configuration.

## Related Documentation

- [API Contracts](/docs/architecture/api-contracts) - Code-first API development
- [Portability Strategy](/docs/architecture/portability) - Migration and portability details
- [Security Guide](/docs/guides/security) - Security baseline and API security