...
- **`contracts/`** - Smart contract code (EVM, Solana) - See [EVM Contracts](/docs/guides/evm-contracts) and [Solana Contracts](/docs/guides/solana-contracts)
...
- [Contract Development Setup](/docs/guides/contract-development) - Setting up Foundry and Anchor
