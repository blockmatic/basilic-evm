...
description: "Decision to use OpenAPI-first approach with hey-api for client generation, REST-first approach, and AI/MCP integration support."
---
...
curl https://api.basilic.dev/reference/openapi.json > openapi.json
