...
For comprehensive usage, deployment examples, and anchor commands, see the [contracts/solana/README.md](../../../../contracts/solana/README.md) file.
...
- [Architecture: Monorepo](/docs/architecture/monorepo) - Package organization
