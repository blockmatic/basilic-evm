...
- [Error Handling](/docs/guides/error-handling) - Error handling with Sentry integration and PII scrubbing
- [Backend Stack](/docs/architecture/backend-stack) - Fastify security headers and CORS configuration
- [Deployment](/docs/guides/deployment) - Deployment security considerations