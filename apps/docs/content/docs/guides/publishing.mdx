...
See the [root scripts README](https://github.com/your-org/your-repo/blob/main/scripts/README.md) for detailed information about the publishing scripts (`prepare-publish.mjs` and `restore-publish.mjs`).
