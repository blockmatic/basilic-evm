...
This guide provides comprehensive documentation for the **wagmi** skill.
...
```bash
# Invoke the skill
claude "wagmi - [your task description]"

# Example
claude "wagmi - analyze the current implementation"
```
