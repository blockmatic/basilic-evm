...
This guide provides comprehensive documentation for the **solidity-development** skill in the custom-plugin-blockchain plugin.
...
```bash
# Invoke the skill
claude "solidity-development - [your task description]"

# Example
claude "solidity-development - analyze the current implementation"
```
...
def implement_solidity_development(input_data):
    """
    Implement solidity-development functionality.
