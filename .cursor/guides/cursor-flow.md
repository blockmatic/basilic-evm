...
> **Navigation**: [← Back to Guides](./README.md) | [Quick Start](./quick-start.md) | [Extensions](./extensions.md)
...
> **Quick Reference**: For a condensed overview, see [quick-start.md](./quick-start.md). For extension setup, see [extensions.md](./extensions.md).

## Understanding Cursor Components

### Mental Model

> **Rules define *how the AI must behave*, Skills add *what it knows*, and Commands decide *when and where it acts*.**
> When there's any conflict, **Rules always win**.
...
> See [extensions.md](./extensions.md) for details on CodeRabbit and other Cursor/VS Code extensions used in this workflow.
